...
<main class="invoice">
    ...
    <footer class="invoice-footer">تم إصدار هذه الفاتورة بواسطة <strong>{{ $companyName }}</strong></footer>
